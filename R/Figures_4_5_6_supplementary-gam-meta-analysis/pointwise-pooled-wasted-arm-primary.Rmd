...
df_analysis <- readRDS(file = here::here("data", "1-final",
  ...
  select(study, pid, region, cluster, arm_primary, iwi, wasted_el) %>% 
...
table(df_analysis$study, df_analysis$wasted_el)
...
df_analysis <- subset(df_analysis, !(study %in% c("DYADG", "DYADM", "HAITI", "PROMISM")))
