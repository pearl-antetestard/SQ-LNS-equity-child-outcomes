...
df_analysis <- readRDS(file = here::here("data", "1-final",
  ...
  select(study, pid, region, cluster, arm_primary, iwi, d5_socioemo_el) %>% 
...
plot_study <- predictions.SS.Comb%>%
  ggplot(., aes(iwi,.fitted, color= arm_primary))+ 
  geom_line(size=1.25)+ 
...
point.wise.DF.SS.Comb$RE.meta  =        point.wise.DF.SS.Comb$RE.meta
point.wise.DF.SS.Comb$RE.meta.upper  =  point.wise.DF.SS.Comb$RE.meta.upper
point.wise.DF.SS.Comb$RE.meta.lower  =  point.wise.DF.SS.Comb$RE.meta.lower
...
# Save the plot
ggsave(here::here("output", "gam_pooled_pointwise_d5_socioemo_el.png"),
