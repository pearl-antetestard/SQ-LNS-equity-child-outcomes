---
title: "Absolute treatment effect by Pointwise meta-analysis - anemia"
...
df_analysis <- readRDS(file = here::here("data", "1-final",
  ...
  select(study, pid, region, cluster, arm_primary, iwi, b2_anemia_el) %>% 
...
plot_study <- predictions.SS.Comb%>%
  ...
  theme_minimal() +
  theme(legend.position = c(0.20,0.77),
          #"none",
...
print(plot_study)
table(df_analysis$study, df_analysis$b2_anemia_el)
...
# Save the plot
ggsave(here::here("output", "gam_pooled_pointwise_anemia.png"),
