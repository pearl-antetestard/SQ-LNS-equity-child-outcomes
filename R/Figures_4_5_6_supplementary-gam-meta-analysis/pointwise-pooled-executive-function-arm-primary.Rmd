...
df_analysis <- readRDS(file = here::here("data", "1-final",
  ...
  select(study, pid, region, cluster, arm_primary, iwi, d12_execfun_el) %>% 
...
plot_study <- predictions.SS.Comb%>%
  ...
  geom_line(size=1.25)+ 
  facet_wrap(.~study, ncol = 1, nrow = 4) + 
...
# Save the plot
ggsave(here::here("output", "gam_pooled_pointwise_d12_execfun_el.png"),
