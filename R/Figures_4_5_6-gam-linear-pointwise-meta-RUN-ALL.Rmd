...
source(here::here("R", "comb-linear-gam-meta-plot.R"))
...
#  ylim(-0.15, 0.25)
combined_plot_laz <- combined_plot_laz + 
  ylab("Difference due to SQ-LNS") +
  theme(legend.position = c(0.40, 0.25)) + ylim(-0.15, 0.25)

plot_comp_effect_laz <- plot_grid(point.wise.DF.SS.Comb.plot_laz, 
                                  combined_plot_laz, ncol = 1)
...
#  ylim(-0.15, 0.25)
combined_plot_wlz <- combined_plot_wlz + 
  ylab("Difference due to SQ-LNS") +
  theme(legend.position = "none") + ylim(-0.15, 0.25)

plot_comp_effect_wlz <- plot_grid(point.wise.DF.SS.Comb.plot_wlz, 
                                  combined_plot_wlz, ncol = 1)
...
#point.wise.DF.SS.Comb.diff.plot_stunted <- point.wise.DF.SS.Comb.diff.plot_stunted +
 # ylim(-0.15, 0.25)
combined_plot_stunted <- combined_plot_stunted + 
    ylab("Difference due to SQ-LNS") +
  theme(legend.position = "none") + ylim(-0.15, 0.25)

plot_comp_effect_stunted <- plot_grid(point.wise.DF.SS.Comb.plot_stunted, combined_plot_stunted, ncol = 1)
...
#   ylim(-0.15, 0.25)
combined_plot_wasted <- combined_plot_wasted + 
    ylab("Difference due to SQ-LNS") +
  theme(legend.position = "none") + ylim(-0.15, 0.25)

plot_comp_effect_wasted <- plot_grid(point.wise.DF.SS.Comb.plot_wasted, combined_plot_wasted, ncol = 1)
...
#point.wise.DF.SS.Comb.diff.plot_severe_stunted <- point.wise.DF.SS.Comb.diff.plot_severe_stunted +
 #  ylim(-0.15, 0.25)
combined_plot_severe_stunted <- combined_plot_severe_stunted + 
    ylab("Difference due to SQ-LNS") +
  theme(legend.position = "none") + ylim(-0.15, 0.25)

plot_comp_effect_severe_stunted <- plot_grid(point.wise.DF.SS.Comb.plot_severe_stunted, 
                                             combined_plot_severe_stunted, ncol = 1)
...
ggsave(here::here("output", "gam_linear_pooled_pointwise_growth_maternal_3.png"),
       plot = plot_composite_growth, width = 20, height = 10, dpi = 300)
...
#point.wise.DF.SS.Comb.diff.plot_language <- point.wise.DF.SS.Comb.diff.plot_language + 
 # ylim(-0.4, 0.4)
combined_plot_language <- combined_plot_language + 
    ylab("Difference due to SQ-LNS") +
  theme(legend.position = c(0.40, 0.25)) + ylim(-0.4, 0.4)

plot_comp_effect_language <- plot_grid(point.wise.DF.SS.Comb.plot_language, combined_plot_language, ncol = 1)
...
#point.wise.DF.SS.Comb.diff.plot_gross <- point.wise.DF.SS.Comb.diff.plot_gross + 
 # ylim(-0.4, 0.4)
combined_plot_gross <- combined_plot_gross + 
    ylab("Difference due to SQ-LNS") +
  theme(legend.position = "none") + ylim(-0.4, 0.4)

plot_comp_effect_gross <- plot_grid(point.wise.DF.SS.Comb.plot_gross, combined_plot_gross, ncol = 1)
...
#  ylim(-0.4, 0.4)
combined_plot_fine <- combined_plot_fine + 
    ylab("Difference due to SQ-LNS") +
  theme(legend.position = "none") + ylim(-0.4, 0.4)

plot_comp_effect_fine <- plot_grid(point.wise.DF.SS.Comb.plot_fine, combined_plot_fine, ncol = 1)
...
#  ylim(-0.4, 0.4)
combined_plot_exec <- combined_plot_exec + 
    ylab("Difference due to SQ-LNS") +
  theme(legend.position = "none") + ylim(-0.4, 0.4)

plot_comp_effect_exec <- plot_grid(point.wise.DF.SS.Comb.plot_exec, combined_plot_exec, ncol = 1)
...
#point.wise.DF.SS.Comb.diff.plot_socioemo <- point.wise.DF.SS.Comb.diff.plot_socioemo + 
 # ylim(-0.4, 0.4)
combined_plot_socioemo <- combined_plot_socioemo + 
    ylab("Difference due to SQ-LNS") +
  theme(legend.position = "none") + ylim(-0.4, 0.4)

plot_comp_effect_socioemo <- plot_grid(point.wise.DF.SS.Comb.plot_socioemo, combined_plot_socioemo, ncol = 1)
...
ggsave(here::here("output", "gam_pooled_pointwise_development_arm_maternal_3.png"),
       plot = plot_composite_development, width = 20, height = 10, dpi = 300)
...
#  ylim(0, 8)
combined_plot_hgb <- combined_plot_hgb + 
    ylab("Difference due to SQ-LNS") +
  theme(legend.position = c(0.70, 0.80)) + ylim(0, 8)

plot_comp_effect_hgb <- plot_grid(point.wise.DF.SS.Comb.plot_hgb, combined_plot_hgb, ncol = 1)
...
#  ylim(-0.2, 0.2)
combined_plot_anemia <- combined_plot_anemia + 
    ylab("Difference due to SQ-LNS") +
  theme(legend.position = "none") + ylim(-0.2, 0.2)

plot_comp_effect_anemia <- plot_grid(point.wise.DF.SS.Comb.plot_anemia, combined_plot_anemia, ncol = 1)

# Combine all the plots
plot_composite_blood <- plot_grid(plot_comp_effect_hgb, 
                                  plot_comp_effect_anemia, ncol=2,
                                   labels = c("A", "B"))
...
ggsave(here::here("output", "gam_pooled_pointwise_blood_arm_maternal_3.png"),
       plot = plot_composite_blood, width = 12, height = 10, dpi = 300)
