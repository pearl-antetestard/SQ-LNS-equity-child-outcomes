---
title: "Objective 1a: Descriptive analysis of child outcomes by arms_maternal"
...
plot_laz <- #ggplot(mean_values_laz, aes(x = study, y = mean_laz_el, 
            ...
            labs(x = "Study", y = "Mean LAZ at endline", color = "SQ-LNS",
...
plot_wlz <- #ggplot(mean_values_wlz, aes(x = study, y = mean_wlz_el, 
            ...
            theme_minimal() +
            coord_flip() +  # Make the plot horizontal
            labs(x = "Study", y = "Mean WLZ at endline", color = "SQ-LNS",
...
plot_stunted <- #ggplot(prevalence_values_stunted, aes(x = study, 
            ...
            theme_minimal() +
            coord_flip() +  # Make the plot horizontal
            labs(x = "Study", y = "Stunting (%)", color = "SQ-LNS",
                 shape = "Maternal intervention", fill = "SQ-LNS") +
            theme(legend.position = "bottom",
                  legend.title = element_blank(),
                  axis.title.y = element_text(size = 18),
...
plot_lang_score <- ggplot(mean_values_d1_lang_el, aes(x=as.factor(study), y=mean_d1_lang_el)) +      
  geom_bar(stat="identity", aes(fill=arms_maternal)) +
  scale_fill_manual(values = c('darkgrey','darkblue')) + 
  # Limits of the plot = very important. The negative value controls the size of the inner circle, the positive one is useful to add size over each bar
  ylim(-0.3,0.3) +
  theme_minimal() +
  labs(x = "Mean language score", 
...
# Create the circular barplot
plot_gross_motor <- ggplot(mean_values_d8_grossmotor_el, aes(x=as.factor(study), y=mean_d8_grossmotor_el)) +      
  geom_bar(stat="identity", aes(fill=arms_maternal)) +
  scale_fill_manual(values = c('darkgrey','darkblue')) + 
  # Limits of the plot = very important. The negative value controls the size of the inner circle, the positive one is useful to add size over each bar
  ylim(-0.3,0.3) +
  theme_minimal() +
  labs(x = "Mean gross motor score", 
...
# Create the circular barplot
plot_fine_motor <- ggplot(mean_values_d10_finemotor_el, aes(x=as.factor(study), y=mean_d10_finemotor_el)) +      
  geom_bar(stat="identity", aes(fill=arms_maternal)) +
  scale_fill_manual(values = c('darkgrey','darkblue')) + 
  # Limits of the plot = very important. The negative value controls the size of the inner circle, the positive one is useful to add size over each bar
  ylim(-0.3,0.3) +
  theme_minimal() +
  labs(x = "Mean fine motor score", 
       #y = "Mean gross motor score", 
       color = "SQ-LNS",
       shape = "SQ-LNS", fill = "SQ-LNS") +
  theme(legend.position = "right",
...
# Create the circular barplot
plot_exec_fun <- ggplot(mean_values_d12_execfun_el, aes(x=as.factor(study), y=mean_d12_execfun_el)) +      
  geom_bar(stat="identity", aes(fill=arms_maternal)) +
  scale_fill_manual(values = c('darkgrey','darkblue')) + 
  # Limits of the plot = very important. The negative value controls the size of the inner circle, the positive one is useful to add size over each bar
  ylim(-0.3,0.3) +
  theme_minimal() +
  labs(x = "Mean executive function score", 
       #y = "Mean gross motor score", 
       color = "SQ-LNS",
       shape = "SQ-LNS", fill = "SQ-LNS") +
  theme(legend.position = "right",
...
# Create the circular barplot
plot_socioemo <- ggplot(mean_values_d5_socioemo_el, aes(x=as.factor(study), y=mean_d5_socioemo_el)) +      
  geom_bar(stat="identity", aes(fill=arms_maternal)) +
  scale_fill_manual(values = c('darkgrey','darkblue')) + 
  # Limits of the plot = very important. The negative value controls the size of the inner circle, the positive one is useful to add size over each bar
  ylim(-0.3,0.3) +
  theme_minimal() +
  labs(x = "Mean socioemotional score", 
       #y = "Mean gross motor score", 
       color = "SQ-LNS",
       shape = "SQ-LNS", fill = "SQ-LNS") +
  theme(legend.position = "right",
...
# Save the combined plots as a PNG
ggsave(here::here("output","combined_plots_dev_el_maternal.png"), plot = combined_plots_dev, width = 16, height = 18, dpi = 300)
